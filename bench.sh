...
tele2=$( wget -O /dev/null http://speedtest.tele2.net/100MB.zip 2>&1 | awk '/\/dev\/null/ {speed=$3 $4} END {gsub(/\(|\)/,"",speed); print speed}' )
echo "Download speed from Tele2.net, Stockholm SE: $tele2"
